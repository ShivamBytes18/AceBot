...
return (
   ...
   shadow-2xl grid md:grid-cols-2 overflow-hidden'>
    ...
    from-green-200 to-gray-100 p-12 flex
   ...
   <p className=" text-gray-600 mb-10">
    Practice real scenarios based interviews powered by AI.
    <br />
    ...
    <div className='space-y-5' >
    {
      [
        ...
        whileHover={{ scale:1.09 }}
         ...
         space-x-4 bg-white p-4 rounded-xl shadow-sm
         cursor-pointer'>
         {item.icon}
       ...
       
       {
        analysisDone && (
          ...
          <h3 className='text-lg font-semibold text-gray-800'>
            ...
            {projects.length > 0 && (
             <div>
               <p className='font-medium text-gary-700 mb-1'>
                Projects :
              </p>
